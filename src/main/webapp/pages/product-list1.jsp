...
<head>
    ...
    <script src="${pageContext.request.contextPath}/plugins/scripts/jquery.js" type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/plugins/scripts/alertify.js" type="text/javascript"></script>
...
<script>
    ...
    $(function () {
            ...
            for(var i=0;i<a.length;i++){
                if(a[i].checked){
                    ...
                    if(productNums==null){
                        ...
                        productNums=productNums+","+temp;

                    }
                }
            }
            deleteProuduct(productNums)
        });
        function deleteProuduct(productNums) {
            $.ajax({
                url : "/crm/deleteProduct",
                type:"post",
                traditional: true,
                dataType : "json",
                data : {
        ...
        function updataProduct(productNums,status) {
            $.ajax({
                url : "/crm/updataProduct",
                type:"post",
                traditional: true,
                dataType : "json",
                data : {
    ...
    function showMsgs(pageNum, pageSize) {
        //发送ajax请求
        $.get("${pageContext.request.contextPath}/findAllProduct/"+pageNum+"/"+pageSize, function (data) {
            ul = $(".pagination");
            ul.empty();
            $("#tbody").empty();
    ...
    function initPagination(total,pageSize) {
        ...
        function pageselectCallback(page_index){
            ...
            if(!isFirst){
                showMsgs(page_index + 1, pageSize);
            }
            isFirst=false;
            return false;
        }
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新" id="refresh"><i
...
<%--                                <td class="text-center">--%>
<%--                                    <button type="submit" class="btn bg-olive btn-xs">订单</button>--%>
<%--                                    <button type="button" class="btn bg-olive btn-xs">详情</button>--%>
<%--                                    <button type="button" class="btn bg-olive btn-xs">编辑</button>--%>
<%--                                </td>--%>
<%--                            </tr>--%>
